...
<body>
    ...
    <div style="height: 384px">
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidatorEmail" runat="server" ControlToValidate="emailText" ErrorMessage="Please enter a valid email address" ForeColor="Red"></asp:RegularExpressionValidator>
        <br />
        <br />
        Password:<br />
        ...
        <br />
        Confirm password:<br />
        <asp:TextBox ID="repeatPasswordText" runat="server" Width="230px" TextMode="Password"></asp:TextBox>
